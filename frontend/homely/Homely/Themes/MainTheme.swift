...
struct MainTheme: ThemeProtocol {
    ...
    //    var textTitleFont: Font = .custom("Graphik-Bold", size: 24.0)
    ...
    //    var textFieldSurfaceThemeColor: Color { return Color("textFieldSurface") }
    //    var filledButtonSurfaceThemeColor: Color { return Color("filledButtonSurface") }
    //    var neutralTextThemeColor: Color { return Color("neutralText") }
